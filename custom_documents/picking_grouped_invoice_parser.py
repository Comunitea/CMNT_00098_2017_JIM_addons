...
class PickingGroupedInvoiceParser(models.AbstractModel):
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render(
            'custom_documents.report_picking_grouped_invoice', docargs)
