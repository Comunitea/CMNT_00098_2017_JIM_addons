...
class PurchaseOrder(models.Model):
    ...
    doc_credit_ok = fields.Boolean(
        "doc credit ok", compute="check_doc_credit_ok"
    )
    ...
    mail_confirm_packing_list = fields.Char(
        "Mail to send p/l",
        help="Mail a la que se envia la copia de la factura y el packing list",
    )
    ...
    def onchange_partner_id(self):
        ...
        self.harbor_id = (
            self.partner_id.harbor_ids and self.partner_id.harbor_ids[0]
        )
