        ...
        if vals.get('default_code', False):
            for product in self:
                if product.stock_move_ids:
                    raise ValidationError(_("You can change code because this product has moves"))
...
class ProductTemplate(models.Model):
    ...
    # Creo que en este caso, si tiene variantes, el default_code puede ser la raiz
    # del default_code del las variantes. Creo que vale así:
