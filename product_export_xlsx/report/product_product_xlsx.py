...
# ~ class ProductWebXslx(models.AbstractModel):
    ...
    # ~ def _get_report_columns(self, report, stock_field, valued):
        ...
        # ~ if valued:
            # ~ columns[5] = {
                # ~ "header": _("cantidad_total"),
                # ~ "field": "cantidad_total",
                # ~ "width": 15,
                # ~ "type": "float",
            # ~ }
            # ~ columns[6] = {
                # ~ "header": _("importe_total"),
                # ~ "field": "importe_total",
                # ~ "width": 15,
                # ~ "type": "float",
            # ~ }
            ...
            # ~ }
            # ~ columns[8] = {
                # ~ "header": _("Precio Medio"),
                # ~ "field": "precio_unitario",
                # ~ "width": 15,
                # ~ "type": "float",
            # ~ }
            # ~ columns[9] = {
                # ~ "header": _("porcentaje_arancel"),
                # ~ "field": "porcentaje_arancel",
                # ~ "width": 15,
                # ~ "type": "float",
            # ~ }
            # ~ columns[10] = {
            ...
            # ~ #               'width': 15, 'type': 'float'}
            # ~ columns[11] = {
                # ~ "header": _("Precio coste medio SAP"),
                # ~ "field": "standard_price",
                # ~ "width": 15,
                # ~ "type": "float",
            # ~ }
            # ~ columns[12] = {
                # ~ "header": _("Numero lineas"),
                # ~ "field": "num_lineas",
                # ~ "width": 10,
                # ~ "type": "float",
            # ~ }
    ...
    # ~ def write_ending_balance(self, my_object, type_object):
        ...
        # ~ super(ProductWebXslx, self).write_ending_balance(my_object, "", "")
