    ...
    def js_download_images(self, images_url=URL, resize=False):
        ...
        with api.Environment.manage():
            with self.pool.cursor() as new_cr:
                ...
                if (
                    irecord.default_code == False
                    or irecord.default_code == None
                    or irecord.default_code == ""
                ):
                    return False
                ...
                if imageBase64tmpl:
                    irecord.with_context(resize_img=resize).write(
                ...
                while True:
                    ...
                    if imageBase64:
                        ...
                        if i == 1 and imageBase64tmpl:
                            ...
                            new_image = (
                                irecord.env["product.image"]
                                .with_context(resize_img=resize)
                                .create(
                                    {
