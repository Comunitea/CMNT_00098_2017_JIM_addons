...
class ProductParameterization(models.Model):
	...
	textil_diseno = fields.Many2many(constants.PARAMETERIZATION_VALUES, 'js_parameterization_field_textil_diseno_rel', 'js_product_parameterization_id', 'js_parameterization_value_id', string='Design', domain=[('fields.name', '=', 'textil_diseno')])
	...
	textil_tipo_bajo = fields.Many2many(constants.PARAMETERIZATION_VALUES, 'js_parameterization_field_textil_tipo_bajo_rel', 'js_product_parameterization_id', 'js_parameterization_value_id', string='Lower finished', domain=[('fields.name', '=', 'textil_tipo_bajo')])
	textil_tipo_cintura = fields.Many2many(constants.PARAMETERIZATION_VALUES, 'js_parameterization_field_textil_tipo_cintura_rel', 'js_product_parameterization_id', 'js_parameterization_value_id', string='Waist type', domain=[('fields.name', '=', 'textil_tipo_cintura')])
